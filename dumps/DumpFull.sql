...
INSERT INTO `tb_catalogo` VALUES (1,'estados unidos da américa','https://cinema10.com.br/upload/featuredImage.php?url=https%3A%2F%2Fcinema10.com.br%2Fupload%2Fseries%2Fseries_5_MV5BZTczMjRjNDItNmFhOS00NmU3LTllMTAtMTk1ZWU0NWJmNzUxXkEyXkFqcGdeQXVyNTA4NzY1MzY%40._V1_SY1000_CR0%2C0%2C701%2C1000_AL_.jpg','friends','seis amigos, três homens e três mulheres, enfrentam a vida e os amores em nova york e adoram passar o tempo livre na cafeteria central park.',1994,'00:30:00','4','2023-06-20',3,3,NULL),(2,'alemanha','https://resizing.flixster.com/lpJkDxnEFNQT1OWJjnmYfvpAHJ0=/ems.cHJkLWVtcy1hc3NldHMvdHZzZXJpZXMvUlRUVjI2NjgyOS53ZWJw','dark','os mistérios sombrios de uma pequena cidade alemã são expostos quando duas crianças desaparecem. enquanto as famílias procuram os dois desaparecidos, eles descobrem uma trama de indivíduos conectados com a história conturbada da cidade.',2017,'01:00:00','4','2023-06-20',4,13,NULL),(3,'turquia','https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcS8ZpUnbnm-JGnAn1cCSxTXL9cEFmO_NcuKvjfRcjpfSMxwzW8S','o último guardião','descobrindo seus laços com uma ordem secreta antiga, um jovem de istambul embarca em uma missão para salvar a cidade de um inimigo imortal.',2018,'00:46:00','3','2023-06-20',3,11,NULL),(4,'brasil','https://i0.wp.com/jornalcomunicacao.ufpr.br/wp-content/uploads/2015/09/21939810.jpg?ssl=1','narcos','conheça a notória e infame história dos mais violentos cartéis de drogas da colômbia.',2015,'00:50:00','5','2023-06-20',5,2,NULL),(5,'frança','https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQaP8TqXAxW2gsObYG6un9xMX9rOYGP3Pgyg8CRaEbhNLnTGO7j','lupin','inspirado pelas aventuras de arsène lupin, o ladrão gentil assane diop quer se vingar de uma família rica por uma injustiça cometida contra o pai dele.',2021,'00:41:00','5','2023-06-20',3,7,NULL),(6,'estados unidos da américa','https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQ7t9b0ixwBWfuade5ehS5PQqZL5_oYUhyDNOa5cQikhrDrqoCP','guerra ao terror','jt sanborn, brian geraghty e matt thompson integram o esquadrão antibombas do exército americano em missão no iraque. eles trabalham na destruição de um explosivo, para que seja detonado sem atingir alguém.',2010,'02:04:00','4','2023-06-20',4,3,NULL),(7,'frança','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTL6g90YvMslOD-T6wi0t9Z_BJDesrL0ZlWbQgpfQZbEQx28LD0','amor','georges e anne são dois idosos apaixonados pela arte e, principalmente, um pelo outro. os desafios da terceira idade afetam sua forma de viver e o modo como se relacionam com a filha, mas o amor entre eles segue inabalável.',2012,'02:12:00','4','2023-06-20',4,7,NULL),(8,'brasil','https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQEuGqzqbuqNJxbBunRYMRTjFzroETQjfVTuFjX9SZ2Z8RJpoZq','cidade de deus','buscapé é um jovem pobre, negro e sensível, que cresce em um universo de muita violência. ele vive na cidade de deus, favela carioca conhecida por ser um dos locais mais violentos do rio.',2002,'02:15:00','4','2023-06-20',4,2,NULL),(9,'espanha','https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcT2Sa82fwsPqpufCGR71t3QrhgohkjqDFiTMTIbDVtDU740XT17','silenciadas','país basco, 1609. um grupo de mulheres acusadas de bruxaria tenta provar sua inocência ao realizar a celebração do sabbath para seus inquisidores.',2020,'01:32:00','3','2023-06-20',1,8,NULL),(10,'thailândes','https://pics.filmaffinity.com/The_Trapped_13_How_We_Survived_the_Thai_Cave-255423550-large.jpg','os 13 sobreviventes da caverna','segue-se o resgate da caverna tham luang, uma missão de 2018 que salvou um time de futebol da associação júnior de uma caverna inundada.',2022,'01:41:00','5','2023-06-20',2,10,NULL);
...
INSERT INTO `tb_classificacao` VALUES (1,10,'não indicado para menores de 14 anos,pois possui violência, drogas, sexo e rock\'n\'roll'),(2,12,'não indicado para menores de 12 anos, apresenta conteúdo de violência extrema, assassinato e incentivo ao uso de entorpecentes'),(3,14,'contraindicado para pessoas que sofrem de algum distúrbio mental ou comportamento agressivo e que seja facilmente influenciada por decisões erradas'),(4,16,'não recomendado para menores de 16 anos, devido a presença de conteúdo adulto, violência doméstica e incitação ao nazismo'),(5,18,'não recomendado para menores de 18 anos, uma vez que esta obra traz diversos aspectos políticos, filosoficos e religiosos que podem facilmente corromper a mente das pessoas');
...
--
-- Dumping routines for database 'db_projeto_final_att'
--
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_ator`(nome_ator VARCHAR(45), sobrenome_ator VARCHAR(45), nascimento DATE, foto_ator VARCHAR(255))
BEGIN
	IF
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_classificacao`(idade_valor INT, descricao_texto VARCHAR(255))
BEGIN
    IF 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_pais`(nome_pais VARCHAR(45), cod_pais CHAR(3))
BEGIN
	IF
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_plano`(nome_plano VARCHAR(45), valor_plano FLOAT, descricao_plano VARCHAR(255))
BEGIN
	IF
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_ator`(valor_id INT, nome_ator VARCHAR(45), sobrenome_ator  VARCHAR(255), data_nascimento_ator VARCHAR(255), FOTO_ATOR VARCHAR(255))
BEGIN
		IF NOT EXISTS
			(SELECT id_ator FROM tb_ator WHERE id_ator = valor_id) THEN
			SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT =  'ID invalido';
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_classificacao`(valor_id INT, idade_valor INT, descricao_texto VARCHAR(255))
BEGIN
		IF NOT EXISTS
			(SELECT id_classificacao FROM tb_classificacao WHERE id_classificacao = valor_id) THEN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_pais`(valor_id INT, nome_pais VARCHAR(45), cod_pais CHAR(3))
BEGIN
		IF NOT EXISTS
			(SELECT id_pais FROM tb_pais WHERE id_pais = valor_id) THEN
			SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT =  'ID invalido';
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_plano`(valor_id INT, nome_plano VARCHAR(45), valor FLOAT, descricao_plano  VARCHAR(255))
BEGIN
		IF NOT EXISTS
			(SELECT id_plano FROM tb_plano WHERE id_plano = valor_id) THEN
			SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT =  'ID invalido';
...
-- Dump completed on 2023-06-21 16:36:25
